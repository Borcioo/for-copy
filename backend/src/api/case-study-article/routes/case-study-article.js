...
//
// /**
//  * case-study-article router
//  */
//
// const { createCoreRouter } = require('@strapi/strapi').factories;
//
// module.exports = createCoreRouter('api::case-study-article.case-study-article');
...
const myOverideRoutes = [
  {
    method: "GET",
    path: "/case-study-articles/:slug",
    handler: "api::case-study-article.case-study-article.findOne",
  },
];
