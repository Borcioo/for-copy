            ...
            >
              ...
              <div className="p-6 space-y-2 relative">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-xs text-gray-400">{formatDate(article.attributes.publishedAt)}</span>
                  {authorsBio && <span className="text-xs text-gray-400">{authorsBio.name}</span>}
                </div>
