              ...
              >
                  ...
                  <span className="text-6xl font-bold ">
                    ...
                    <span
                      className={`ml-1 text-sm tracking-wid ${
                        plan.isRecommended ? "text-gray-900" : "text-violet-500"
                      }`}
                    >
                  ...
                  {plan.product_features.data.map((feature: Feature) => (
                    <li key={feature.id} className="flex mb-2 space-x-2">
                      <svg
                        ...
                        viewBox="0 0 20 20"
                        fill="currentColor"
                        className={`flex-shrink-0 w-6 h-6 ${plan.isRecommended ? "text-gray-900" : "text-gray-400"}`}
                      >
                        <path
                          fillRule="evenodd"
                ...
                <button
                  ...
                  className={`inline-block px-5 py-3 font-semibold tracking-wider text-center rounded   ${
                    plan.isRecommended ? "bg-gray-900 text-violet-400" : "bg-violet-400 text-gray-900"
                  }`}
                >
                  Get Started
                </button>
